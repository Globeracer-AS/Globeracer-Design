...
data class Dimens(
    ...
    val paragraphSpacingBodyXSm: TextUnit = 2.sp,
    val paragraphSpacingBodyMd: TextUnit = 6.sp,
    val paragraphSpacingBodyLg: TextUnit = 8.sp,
    val paragraphSpacingHeadingLg: TextUnit = 16.sp,
    val paragraphSpacingHeadingXLg: TextUnit = 24.sp,
    val paragraphSpacingHeading2xLg: TextUnit = 32.sp,
    val paragraphSpacingHeading3xLg: TextUnit = 36.sp,
    val paragraphSpacingHeading4xLg: TextUnit = 40.sp,
    val paragraphSpacingBodySm: TextUnit = 4.sp,
    val paragraphSpacingHeading5xLg: TextUnit = 48.sp,
