...
data class Dimens(
    ...
    val lineHeightHeadingLg: Dp = 24.dp,
    val lineHeightHeadingXLg: Dp = 28.dp,
    val lineHeightHeading2xLg: Dp = 36.dp,
    val lineHeightHeading3xLg: Dp = 48.dp,
    val lineHeightHeading4xLg: Dp = 56.dp,
    val lineHeightHeading5xLg: Dp = 76.dp,
